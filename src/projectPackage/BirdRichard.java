...
public class BirdRichard extends JPanel {
	...
	public BirdRichard(MainFrame mainFrame) {
		...
		lblNewLabel_5.setBounds(464, 131, 590, 15);
		add(lblNewLabel_5);
		...
		textArea_1.setBounds(464, 275, 558, 356);
		add(textArea_1);
