...
public class BirdRichard extends JPanel {
	...
	public BirdRichard(MainFrame mainFrame) {
		...
		lblNewLabel_5.setBounds(468, 182, 590, 15);
		add(lblNewLabel_5);
		...
		textArea_1.setBounds(468, 326, 558, 396);
		add(textArea_1);
