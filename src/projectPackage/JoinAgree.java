...
public class JoinAgree extends JPanel {
    ...
    public JoinAgree() {
        ...
        lblNewLabel_2.setBounds(732, 168, 57, 15);
        add(lblNewLabel_2);
        ...
        lblNewLabel_4.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 18));
        ...
        lblNewLabel_7.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 18));
