...
public class JoinAgree extends JPanel {
    ...
    public JoinAgree(MainFrame mainFrame) {
        ...
        lblNewLabel_1_1.setBounds(799, 44, 301, 42);
        add(lblNewLabel_1_1);
    }
