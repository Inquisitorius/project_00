...
public class JoinAgree extends JPanel {
    ...
    public JoinAgree() {
        ...
        lblNewLabel_6.setBounds(756, 320, 39, 15);
        add(lblNewLabel_6);
        
        textField_3 = new JTextField();
        textField_3.setColumns(10);
        textField_3.setBounds(846, 354, 341, 32);
        add(textField_3);
        
        JLabel lblNewLabel_7 = new JLabel("이메일");
        lblNewLabel_7.setForeground(Color.WHITE);
        lblNewLabel_7.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 14));
        lblNewLabel_7.setBounds(756, 361, 39, 15);
        add(lblNewLabel_7);
        
        JLabel lblNewLabel_8 = new JLabel("휴대전화");
        lblNewLabel_8.setForeground(Color.WHITE);
        lblNewLabel_8.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 14));
        lblNewLabel_8.setBounds(756, 403, 66, 15);
        add(lblNewLabel_8);
        
        textField_4 = new JTextField();
        textField_4.setColumns(10);
        textField_4.setBounds(846, 396, 341, 32);
        add(textField_4);
        
        JButton btnNewButton_1 = new JButton("");
        btnNewButton_1.setIcon(new ImageIcon(JoinAgree.class.getResource("/image/button/back.png")));
        btnNewButton_1.setBounds(829, 498, 110, 42);
        add(btnNewButton_1);
        ...
        btnNewButton_2.setBounds(972, 498, 110, 42);
        add(btnNewButton_2);
        
        JLabel lblNewLabel = new JLabel("J O I N");
        lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
        lblNewLabel.setFont(new Font("나눔고딕 ExtraBold", Font.PLAIN, 48));
        lblNewLabel.setForeground(Color.WHITE);
        lblNewLabel.setBounds(502, 36, 172, 42);
        add(lblNewLabel);

        // Item listener to synchronize checkbox_1 and checkbox_2 with checkbox_3
